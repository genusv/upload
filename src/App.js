...
<select style={_sabrun("3")} name="subjectX" id="subjectX" onChange={e=> s_subject(e.currentTarget.value)} >
  ...
  {/*--------------------------------------------------------------------------- */}
  <select style={_sabrun("X")} name="subjectX" id="subjectX" onChange={e=> s_subject(e.currentTarget.value)} >
  <option  id="bold" value="">High school courses</option>
  <option  value="">-----------------------------------</option>
  ...
  <option  value="Environmental science">Environmental science</option>
  <option  value="Forensic science">Forensic science</option>
  <option  value="Computer Science">Geology</option>
  <option  value="Marine biology">Marine biology</option>
